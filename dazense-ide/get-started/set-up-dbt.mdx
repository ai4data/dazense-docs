---
title: dbt setup
description: "dazense offers direct integration with dbt, enabling users to preview models, access lineage information, and provide dbt tools to the AI assistant. Addition..."
---

dazense offers direct integration with dbt, enabling users to preview models, access lineage information, and provide dbt tools to the AI assistant. Additional details about dazense and dbt capabilities are available in the [Work with dbt](/dazense-ide/features/work-with-dbt) section.
