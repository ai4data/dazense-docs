---
title: FAQ
description: "You can view the query definition behind a database view using the agent. Ask the agent to \"show me the query for view viewname\" or use the agent's warehouse..."
---

> Frequently asked questions about dazense
