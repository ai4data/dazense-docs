...
<Warning>Never commit secrets directly in your workflow file. Always use GitHub Secrets.</Warning>
...
<Info>The workflow automatically commits and pushes any changes from `dazense sync` back to your repository, keeping your context files up to date.</Info>
