...
> Configure users, authentication, models, and prompts for dazense chat

As an admin, you can configure how your team accesses dazense chat, manage integrations, choose models, and customize agent behavior.
...
> **Warning:** If you configure Google OAuth, users can sign in with their Google accounts. Make sure to set allowed domains if you want to restrict access to your organization.
