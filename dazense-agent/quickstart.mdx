---
title: Quickstart
description: "This command will ask you:"
---
...
<Note>You can skip any optional question and configure them later in your `dazense_config.yaml` file.</Note>
...
Then, mesure agent's performance on examples with dazense test command:
