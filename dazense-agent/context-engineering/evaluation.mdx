---
title: Evaluation
description: "Measure and improve your agent's performance with unit tests using the dazense test command."
---
...
For Trusted Analytics V1/V2, combine `dazense test` with governance checks:
